...
src="$build_root/chroot/var/lib/jamlinux/external-debs"
...
mkdir -p "$dst"
cp -a "$src/." "$dst/"
echo "[jamlinux binary hook] Staged $staged_count external .deb files for installed-system provisioning:"
ls -1 "$dst"
HOOK
